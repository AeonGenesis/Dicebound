...
function randomDistinguishingFeature () {
    const randomCategory = Object.keys(distinguishingFeatures)[Math.floor(Math.random() * Object.keys(distinguishingFeatures).length)];
    const randomFeature = distinguishingFeatures[randomCategory][Math.floor(Math.random() * distinguishingFeatures[randomCategory].length)];
...
function calculateHeight (defaultHeight, dice) {
    const heightInCentimeters = (defaultHeight + ([...Array(dice)]
        .map(() => d6())
        .reduce((currentValue, nextValue) => nextValue + currentValue)));
...
class HumanFeatures {
    constructor() {
        ...
        this.eyeColor = eyeColor.human[Math.floor(Math.random() * eyeColor.human.length)];
        this.hairColor = hairColor.human[Math.floor(Math.random() * hairColor.human.length)];
...
class AelfFeatures {
    constructor() {
        ...
        this.eyeType = eyeType[Math.floor(Math.random() * eyeType.length)];
        this.eyeColor = eyeColor.aelf[Math.floor(Math.random() * eyeColor.aelf.length)];
        this.hairColor = hairColor.aelf[Math.floor(Math.random() * hairColor.aelf.length)];
...
class DuardinFeatures {
    constructor() {
        ...
        this.eyeType = eyeType[Math.floor(Math.random() * eyeType.length)];
        this.eyeColor = eyeColor.duardin[Math.floor(Math.random() * eyeColor.duardin.length)];
        this.hairColor = hairColor.duardin[Math.floor(Math.random() * hairColor.duardin.length)];
...
class SylvanethFeatures {
    constructor() {
        ...
        this.eyeType = eyeType[Math.floor(Math.random() * eyeType.length)];
        this.eyeColor = eyeColor.sylvaneth[Math.floor(Math.random() * eyeColor.sylvaneth.length)];
        this.hairColor = hairColor.sylvaneth[Math.floor(Math.random() * hairColor.sylvaneth.length)];
